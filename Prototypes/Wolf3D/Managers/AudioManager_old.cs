...
//internal class AudioManager_old
//{
...
//    internal int Play(string sound)
//    {
...
//        {
//            Console.WriteLine($"{nameof(Play)}({sound}) - Sound not found.");
//            return 0;
//            //throw new PfWolfAudioException("Play({sound}) - Uncached sound", sound);
//        }
...
//        if (s.Length == 0)
//            throw new PfWolfAudioException("Play() - Zero length sound");
...
//        //foreach (var kvp in SoundChunks)
//        //{
//        //    foreach (var buffer in kvp.Value.buffers)
//        //    {
//        //        ALC.DeleteBuffer(buffer);
//        //    }
//        //    ALC.DeleteSource(kvp.Value.source);
//        //}
...
//            SoundChunks[which] = (new uint[] { buffer }, source);
//        }
//        catch (Exception e)
//        {
...
//        if (!SoundChunks.TryGetValue(which, out var bufferSource))
//        {
//            Console.WriteLine($"SoundChunks[{which}] is NULL!");
//            return 0;
//        }

//        Al.SourcePlay(bufferSource.source);
//        int err = Al.GetError();
//        //if (which >= NumDigi)
