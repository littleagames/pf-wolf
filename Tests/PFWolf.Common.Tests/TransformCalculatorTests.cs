...
public class TransformCalculatorTests
{
    ...
    //[TestCase(640, 400, 0, 0, AnchorPoint.TopCenter, PositionType.Relative, 88, 64, 0, 0, -88, 0, TestName = "Relative top-center at 0,0")]
    //[TestCase(640, 400, 0, 0, AnchorPoint.TopRight, PositionType.Relative, 88, 64, 0, 0, -176, 0, TestName = "Relative top-right at 0,0")]
    //[TestCase(640, 400, 0, 0, AnchorPoint.MiddleLeft, PositionType.Relative, 88, 64, 0, 0, 0, -64, TestName = "Relative middle-left at 0,0")]
    //[TestCase(640, 400, 0, 0, AnchorPoint.Center, PositionType.Relative, 88, 64, 0, 0, -88, -64, TestName = "Relative center at 0,0")]
    //[TestCase(640, 400, 0, 0, AnchorPoint.MiddleRight, PositionType.Relative, 88, 64, 0, 0, -176, -64, TestName = "Relative middle-right at 0,0")]
    //[TestCase(640, 400, 0, 0, AnchorPoint.BottomLeft, PositionType.Relative, 88, 64, 0, 0, 0, -128, TestName = "Relative bottom-left at 0,0")]
    //[TestCase(640, 400, 0, 0, AnchorPoint.BottomCenter, PositionType.Relative, 88, 64, 0, 0, -88, -128, TestName = "Relative bottom-center at 0,0")]
    //[TestCase(640, 400, 0, 0, AnchorPoint.BottomRight, PositionType.Relative, 88, 64, 0, 0, -176, -128, TestName = "Relative bottom-right at 0,0")]
        ...
        int expectedOffsetY)
    {
        ...
        Assert.That(transform.Position, Is.EqualTo(new Point(expectedPositionX, expectedPositionY)), "Position is not equal to expected value.");
        Assert.That(transform.Offset, Is.EqualTo(new Point(expectedOffsetX, expectedOffsetY)), "Offset is not equal to expected value.");
    }
    ...
    //[TestCase(640, 400, 0, 0, AnchorPoint.TopLeft, PositionType.Absolute, 88, 64, AnchorPoint.BottomCenter, 0, 0, 320, 400, 176, 128, TestName = "Absolute position top-left at 0,0 scales graphic from screen bottom-center")]
    ...
    //[TestCase(640, 480, 50, 32, AnchorPoint.TopLeft, PositionType.Absolute, 88, 64, AnchorPoint.TopLeft, 60, 32, 0, 0, 176, 128, TestName = "Non 4:3, absolute position top-left at non-zero scales graphic from screen top-left")]
    //[TestCase(640, 400, 50, 32, AnchorPoint.TopLeft, PositionType.Absolute, 88, 64, AnchorPoint.TopCenter, 270, 32, 0, 0, 176, 128, TestName = "Absolute position top-left at non-zero scales graphic from screen top-center")]
    //[TestCase(640, 480, 50, 32, AnchorPoint.TopLeft, PositionType.Absolute, 88, 64, AnchorPoint.TopCenter, 270, 32, 0, 0, 176, 128, TestName = "Non 4:3, absolute position top-left at non-zero scales graphic from screen top-center")]
    //[TestCase(640, 400, 50, 32, AnchorPoint.TopLeft, PositionType.Absolute, 88, 64, AnchorPoint.TopRight, 590, 32, 0, 0, 176, 128, TestName = "Absolute position top-left at non-zero scales graphic from screen top-right")]
    //[TestCase(640, 480, 50, 32, AnchorPoint.TopLeft, PositionType.Absolute, 88, 64, AnchorPoint.TopRight, 590, 32, 0, 0, 176, 128, TestName = "Non 4:3, absolute position top-left at non-zero scales graphic from screen top-right")]
    ...
    //[TestCase(640, 400, 50, 32, AnchorPoint.TopLeft, PositionType.Absolute, 88, 64, AnchorPoint.Center, 270, 232, 0, 0, 176, 128, TestName = "Absolute position top-left at non-zero scales graphic from screen center")]
    //[TestCase(640, 480, 50, 32, AnchorPoint.TopLeft, PositionType.Absolute, 88, 64, AnchorPoint.Center, 270, 272, 0, 0, 176, 128, TestName = "Non 4:3, absolute position top-left at non-zero scales graphic from screen center")]
    //[TestCase(640, 400, 50, 32, AnchorPoint.TopLeft, PositionType.Absolute, 88, 64, AnchorPoint.MiddleRight, 590, 232, 0, 0, 176, 128, TestName = "Absolute position top-left at non-zero scales graphic from screen middle-right")]
    //[TestCase(640, 480, 50, 32, AnchorPoint.TopLeft, PositionType.Absolute, 88, 64, AnchorPoint.MiddleRight, 590, 272, 0, 0, 176, 128, TestName = "Non 4:3, absolute position top-left at non-zero scales graphic from screen middle-right")]
    ...
    //[TestCase(640, 400, 50, 32, AnchorPoint.TopLeft, PositionType.Absolute, 88, 64, AnchorPoint.BottomCenter, 270, 432, 0, 0, 176, 128, TestName = "Absolute position top-left at non-zero scales graphic from screen bottom-center")]
    //[TestCase(640, 480, 50, 32, AnchorPoint.TopLeft, PositionType.Absolute, 88, 64, AnchorPoint.BottomCenter, 270, 512, 0, 0, 176, 128, TestName = "Non 4:3, absolute position top-left at non-zero scales graphic from screen bottom-center")]
    //[TestCase(640, 400, 50, 32, AnchorPoint.TopLeft, PositionType.Absolute, 88, 64, AnchorPoint.BottomRight, 590, 432, 0, 0, 176, 128, TestName = "Absolute position top-left at non-zero scales graphic from screen bottom-right")]
    //[TestCase(640, 480, 50, 32, AnchorPoint.TopLeft, PositionType.Absolute, 88, 64, AnchorPoint.BottomRight, 590, 512, 0, 0, 176, 128, TestName = "Non 4:3, absolute position top-left at non-zero scales graphic from screen bottom-right")]
